...
<head>
    ...
    <title>Laravel Dynamic Table</title>
...
<body class="antialiased">
    <div
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <table id="data-table" class="bordered responsive-table">
                <thead>
    ...
    <script>
        // Define data
        var data =
            '{"result":{"company 1":[{"branch 1":["s1","s2"]},{"branch 2":["s3","s4","s5"]},{"branch 3":["s6","s7","s8","s9"]}],"company 2":[{"branch 4":["s10","s11", "s12","s13","s14"]},{"branch 5":["s15","s16","s17","s18","s19","s20"]}]},"Build sets":"yyy","destinationPath":"xxx","status":1}';

        function generateTable(data) { //data is the parsed JSON Object from an ajax request
            data = JSON.parse(data);
            $("#data-table tbody").empty(); //Empty the table first
            Object.entries(data.result).forEach(([key, elem]) => {
                ...
                $("#data-table").append(baseHtml + childrenHtml);
            });
        }
